...
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_IE_effect_mons.png', plot = sd_mons_IE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_mons_SE_effect <- ggplot(barren_land, aes(x = `Barren Land`, y = mons_SE_effect))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_SE_effect_mons.png', plot = sd_mons_SE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_mons_IE_thresh <- ggplot(barren_land, aes(x = `Barren Land`, y = mons_IE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_IE_thresh_mons.png', plot = sd_mons_IE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_SE_thresh_mons.png', plot = sd_mons_SE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_mons_Storage_thresh <- ggplot(barren_land, aes(x = `Barren Land`, y = mons_Storage_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_Storage_thresh_mons.png', plot = sd_mons_Storage_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_mons_R_Pvol_RC <- ggplot(barren_land, aes(x = `Barren Land`, y = mons_R_Pvol_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_R_Pvol_RC_mons.png', plot = sd_mons_R_Pvol_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_mons_R_Pint_RC <- ggplot(barren_land, aes(x = `Barren Land`, y = mons_R_Pint_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_R_Pint_RC_mons.png', plot = sd_mons_R_Pint_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_IE_effect <- ggplot(barren_land, aes(x = `Barren Land`, y = IE_effect))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_IE_effect.png', plot = sd_IE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_SE_effect <- ggplot(barren_land, aes(x = `Barren Land`, y = SE_effect))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_SE_effect.png', plot = sd_SE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_IE_thresh <- ggplot(barren_land, aes(x = `Barren Land`, y = IE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_IE_thresh.png', plot = sd_IE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_SE_thresh <- ggplot(barren_land, aes(x = `Barren Land`, y = SE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_SE_thresh.png', plot = sd_SE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_Storage_thresh <- ggplot(barren_land, aes(x = `Barren Land`, y = Storage_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_Storage_thresh.png', plot = sd_Storage_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_R_Pvol_RC <- ggplot(barren_land, aes(x = `Barren Land`, y = R_Pvol_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_R_Pvol_RC.png', plot = sd_R_Pvol_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_R_Pint_RC <- ggplot(barren_land, aes(x = `Barren Land`, y = R_Pint_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_R_Pint_RC.png', plot = sd_R_Pint_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_IE_grid <- plot_grid(sd_IE_effect, sd_mons_IE_effect,
                        ...
                        ncol = 2)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_IE_grid.png', plot = sd_IE_grid, width = 6, height = 7.5, units = c('in'), dpi = 300, bg = 'white')
sd_IE_grid
...
sd_SE_grid <- plot_grid(sd_SE_effect, sd_mons_SE_effect,
                        ...
                        ncol = 2)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_BarrenLand_SE_grid.png', plot = sd_SE_grid, width = 6, height = 7.5, units = c('in'), dpi = 300, bg = 'white')
sd_SE_grid
...
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_IE_effect_mons.png', plot = sd_mons_IE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_mons_IE_effect_cor)
...
sd_mons_SE_effect <- ggplot(density, aes(x = `Stream Density`, y = mons_SE_effect))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_SE_effect_mons.png', plot = sd_mons_SE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_mons_SE_effect_cor)
...
sd_mons_IE_thresh <- ggplot(density, aes(x = `Stream Density`, y = mons_IE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_IE_thresh_mons.png', plot = sd_mons_IE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_mons_IE_thresh_cor)
...
sd_mons_SE_thresh <- ggplot(density, aes(x = `Stream Density`, y = mons_SE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_SE_thresh_mons.png', plot = sd_mons_SE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_mons_SE_thresh_cor)
...
sd_mons_Storage_thresh <- ggplot(density, aes(x = `Stream Density`, y = mons_Storage_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_Storage_thresh_mons.png', plot = sd_mons_Storage_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_mons_Storage_thresh_cor)
...
sd_mons_R_Pvol_RC <- ggplot(density, aes(x = `Stream Density`, y = mons_R_Pvol_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_R_Pvol_RC_mons.png', plot = sd_mons_R_Pvol_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_mons_R_Pint_RC <- ggplot(density, aes(x = `Stream Density`, y = mons_R_Pint_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_R_Pint_RC_mons.png', plot = sd_mons_R_Pint_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
sd_IE_effect <- ggplot(density, aes(x = `Stream Density`, y = IE_effect))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_IE_effect.png', plot = sd_IE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_IE_effect_cor)
...
sd_SE_effect <- ggplot(density, aes(x = `Stream Density`, y = SE_effect))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_SE_effect.png', plot = sd_SE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_SE_effect_cor)
...
sd_IE_thresh <- ggplot(density, aes(x = `Stream Density`, y = IE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_IE_thresh.png', plot = sd_IE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_IE_thresh_cor)
...
sd_SE_thresh <- ggplot(density, aes(x = `Stream Density`, y = SE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_SE_thresh.png', plot = sd_SE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_SE_thresh_cor)
...
sd_Storage_thresh <- ggplot(density, aes(x = `Stream Density`, y = Storage_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_Storage_thresh.png', plot = sd_Storage_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_Storage_thresh_cor)
...
sd_R_Pvol_RC <- ggplot(density, aes(x = `Stream Density`, y = R_Pvol_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_R_Pvol_RC.png', plot = sd_R_Pvol_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_R_Pvol_RC_cor)
...
sd_R_Pint_RC <- ggplot(density, aes(x = `Stream Density`, y = R_Pint_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_R_Pint_RC.png', plot = sd_R_Pint_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(sd_R_Pint_RC_cor)
...
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_IE_grid.png', plot = sd_IE_grid, width = 6, height = 7.5, units = c('in'), dpi = 300, bg = 'white')
sd_IE_grid
...
sd_SE_grid <- plot_grid(sd_SE_effect, sd_mons_SE_effect,
                        ...
                        sd_Storage_thresh, sd_mons_Storage_thresh,
                        ncol = 2)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_StreamDensity_SE_grid.png', plot = sd_SE_grid, width = 6, height = 7.5, units = c('in'), dpi = 300, bg = 'white')
sd_SE_grid
...
## KSAT ------------------------------
ksat <- read.csv('./AZ_KSAT.csv')
ksat[,2:4] <- ksat[,2:4]/100
ksat <- ksat %>% select(-c(ksat_varia))
...
# Monsoon IE Effect ----
ksat_mons_IE_effect_cor <- cor.test(x =ksat$ksat_mean, y =ksat$mons_IE_effect, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_mons_IE_effect_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_mons_IE_effect <- ggplot(ksat, aes(x = ksat_mean, y = mons_IE_effect))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(y = '', x = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_IE_effect_mons.png', plot = ksat_mons_IE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_mons_IE_effect_cor)

# Monsoon SE effect ----
ksat_mons_SE_effect_cor <- cor.test(x =ksat$ksat_mean, y =ksat$mons_SE_effect, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_mons_SE_effect_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_mons_SE_effect <- ggplot(ksat, aes(x = ksat_mean, y = mons_SE_effect))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(y = '', x = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_SE_effect_mons.png', plot = ksat_mons_SE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_mons_SE_effect_cor)

# Monsoon IE thresh ----
ksat_mons_IE_thresh_cor <- cor.test(x =ksat$ksat_mean, y =ksat$mons_IE_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_mons_IE_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_mons_IE_thresh <- ggplot(ksat, aes(x = ksat_mean, y = mons_IE_thresh))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(y = '', x = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_IE_thresh_mons.png', plot = ksat_mons_IE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_mons_IE_thresh_cor)

# Monsoon SE thresh ----
ksat_mons_SE_thresh_cor <- cor.test(x =ksat$ksat_mean, y =ksat$mons_SE_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_mons_SE_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_mons_SE_thresh <- ggplot(ksat, aes(x = ksat_mean, y = mons_SE_thresh))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(y = '', x = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_SE_thresh_mons.png', plot = ksat_mons_SE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_mons_SE_thresh_cor)

# Monsoon Storage thresh ----
ksat_mons_Storage_thresh_cor <- cor.test(x =ksat$ksat_mean, y =ksat$mons_Storage_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_mons_Storage_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_mons_Storage_thresh <- ggplot(ksat, aes(x = ksat_mean, y = mons_Storage_thresh))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(x = 'Ksat', y = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_Storage_thresh_mons.png', plot = ksat_mons_Storage_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_mons_Storage_thresh_cor)

# Monsoon R Pvol ----
ksat_mons_R_Pvol_RC_cor <- cor.test(x =ksat$ksat_mean, y =ksat$mons_R_Pvol_RC, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_mons_R_Pvol_RC_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_mons_R_Pvol_RC <- ggplot(ksat, aes(x = ksat_mean, y = mons_R_Pvol_RC))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(x = '', y = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_R_Pvol_RC_mons.png', plot = ksat_mons_R_Pvol_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_mons_R_Pvol_RC_cor)

# Monsoon R Pint ----
ksat_mons_R_Pint_RC_cor <- cor.test(x =ksat$ksat_mean, y =ksat$mons_R_Pint_RC, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_mons_R_Pint_RC_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_mons_R_Pint_RC <- ggplot(ksat, aes(x = ksat_mean, y = mons_R_Pint_RC))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(x = 'Ksat', y = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_R_Pint_RC_mons.png', plot = ksat_mons_R_Pint_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_mons_R_Pint_RC_cor)

#  IE Effect ----
ksat_IE_effect_cor <- cor.test(x =ksat$ksat_mean, y =ksat$IE_effect, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_IE_effect_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_IE_effect <- ggplot(ksat, aes(x = ksat_mean, y = IE_effect))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color='#DD8D29')+
  labs(x = '', y = 'IE Effect')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_IE_effect.png', plot = ksat_IE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_IE_effect_cor)

#  SE effect ----
ksat_SE_effect_cor <- cor.test(x =ksat$ksat_mean, y =ksat$SE_effect, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_SE_effect_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_SE_effect <- ggplot(ksat, aes(x = ksat_mean, y = SE_effect))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  labs(x = '', y = 'SE Effect')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_SE_effect.png', plot = ksat_SE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_SE_effect_cor)

#  IE thresh ----
ksat_IE_thresh_cor <- cor.test(x =ksat$ksat_mean, y =ksat$IE_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_IE_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_IE_thresh <- ggplot(ksat, aes(x = ksat_mean, y = IE_thresh))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  labs(x = '', y = 'IE Thresh')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_IE_thresh.png', plot = ksat_IE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_IE_thresh_cor)

#  SE thresh ----
ksat_SE_thresh_cor <- cor.test(x =ksat$ksat_mean, y =ksat$SE_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_SE_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_SE_thresh <- ggplot(ksat, aes(x = ksat_mean, y = SE_thresh))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  labs(x = '', y = 'SE Thresh')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_SE_thresh.png', plot = ksat_SE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_SE_thresh_cor)

#  Storage thresh ----
ksat_Storage_thresh_cor <- cor.test(x =ksat$ksat_mean, y =ksat$Storage_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_Storage_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_Storage_thresh <- ggplot(ksat, aes(x = ksat_mean, y = Storage_thresh))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_Storage_thresh.png', plot = ksat_Storage_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_Storage_thresh_cor)

#  R Pvol ----
ksat_R_Pvol_RC_cor <- cor.test(x =ksat$ksat_mean, y =ksat$R_Pvol_RC, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_R_Pvol_RC_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_R_Pvol_RC <- ggplot(ksat, aes(x = ksat_mean, y = R_Pvol_RC))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  labs(x = '', y = 'R Pvol RC')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_R_Pvol_RC.png', plot = ksat_R_Pvol_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(ksat_R_Pvol_RC_cor)

#  R Pint ----
ksat_R_Pint_RC_cor <- cor.test(x =ksat$ksat_mean, y =ksat$R_Pint_RC, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(ksat_R_Pint_RC_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
ksat_R_Pint_RC <- ggplot(ksat, aes(x = ksat_mean, y = R_Pint_RC))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_R_Pint_RC.png', plot = ksat_R_Pint_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
ksat_IE_grid <- plot_grid(ksat_IE_effect, ksat_mons_IE_effect,
                        ...
                        ncol = 2)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_IE_grid.png', plot = ksat_IE_grid, width = 6, height = 7.5, units = c('in'), dpi = 300, bg = 'white')
...
ksat_SE_grid <- plot_grid(ksat_SE_effect, ksat_mons_SE_effect,
                        ...
                        ncol = 2)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Ksat_SE_grid.png', plot = ksat_SE_grid, width = 6, height = 7.5, units = c('in'), dpi = 300, bg = 'white')
ksat_SE_grid
...
# 
# # DEPTH TO BEDROCK ---------------------------
DTBR <- read.csv('./AZ_DTBR.csv')

SP_df <- merge(SP_df, DTBR, by.x = 'site', by.y = 'GAGE_ID')
colnames(SP_df)[41:42] <- c('DTBR_mean', 'DTBR_median')
DTBR <- merge(sigs, DTBR, by.x = 'site', by.y = 'GAGE_ID', all.x = TRUE, all.y = FALSE)


# # Monsoon IE Effect ----
DTBR_mons_IE_effect_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$mons_IE_effect, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_mons_IE_effect_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_mons_IE_effect <- ggplot(DTBR, aes(x = DTBR_mean, y = mons_IE_effect))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(x = '', y = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_IE_effect_mons.png', plot = DTBR_mons_IE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_mons_IE_effect_cor)

# Monsoon SE effect ----
DTBR_mons_SE_effect_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$mons_SE_effect, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_mons_SE_effect_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_mons_SE_effect <- ggplot(DTBR, aes(x = DTBR_mean, y = mons_SE_effect))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(y = '', x = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_SE_effect_mons.png', plot = DTBR_mons_SE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_mons_SE_effect_cor)

# Monsoon IE thresh ----
DTBR_mons_IE_thresh_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$mons_IE_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_mons_IE_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_mons_IE_thresh <- ggplot(DTBR, aes(x = DTBR_mean, y = mons_IE_thresh))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(y = '', x = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_IE_thresh_mons.png', plot = DTBR_mons_IE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_mons_IE_thresh_cor)

# Monsoon SE thresh ----
DTBR_mons_SE_thresh_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$mons_SE_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_mons_SE_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_mons_SE_thresh <- ggplot(DTBR, aes(x = DTBR_mean, y = mons_SE_thresh))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(y = '', x = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_SE_thresh_mons.png', plot = DTBR_mons_SE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')

rm(DTBR_mons_SE_thresh_cor)

# Monsoon Storage thresh ----
DTBR_mons_Storage_thresh_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$mons_Storage_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_mons_Storage_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_mons_Storage_thresh <- ggplot(DTBR, aes(x = DTBR_mean, y = mons_Storage_thresh))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_Storage_thresh_mons.png', plot = DTBR_mons_Storage_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_mons_Storage_thresh_cor)

# Monsoon R Pvol ----
DTBR_mons_R_Pvol_RC_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$mons_R_Pvol_RC, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_mons_R_Pvol_RC_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_mons_R_Pvol_RC <- ggplot(DTBR, aes(x = DTBR_mean, y = mons_R_Pvol_RC))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(y = '', x = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_R_Pvol_RC_mons.png', plot = DTBR_mons_R_Pvol_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_mons_R_Pvol_RC_cor)

# Monsoon R Pint ----
DTBR_mons_R_Pint_RC_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$mons_R_Pint_RC, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_mons_R_Pint_RC_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_mons_R_Pint_RC <- ggplot(DTBR, aes(x = DTBR_mean, y = mons_R_Pint_RC))+
  geom_point(color = '#46ACC8')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#46ACC8')+
  labs(y = '', x = '')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_R_Pint_RC_mons.png', plot = DTBR_mons_R_Pint_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_mons_R_Pint_RC_cor)

#  IE Effect ----
DTBR_IE_effect_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$IE_effect, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_IE_effect_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_IE_effect <- ggplot(DTBR, aes(x = DTBR_mean, y = IE_effect))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color='#DD8D29')+
  labs(x = '', y = 'IE Effect')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_IE_effect.png', plot = DTBR_IE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_IE_effect_cor)

#  SE effect ----
DTBR_SE_effect_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$SE_effect, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_SE_effect_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_SE_effect <- ggplot(DTBR, aes(x = DTBR_mean, y = SE_effect))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  labs(x = '', y = 'SE Effect')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_SE_effect.png', plot = DTBR_SE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_SE_effect_cor)

#  IE thresh ----
DTBR_IE_thresh_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$IE_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_IE_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_IE_thresh <- ggplot(DTBR, aes(x = DTBR_mean, y = IE_thresh))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  labs(x = '', y = 'IE Thresh')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_IE_thresh.png', plot = DTBR_IE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_IE_thresh_cor)

#  SE thresh ----
DTBR_SE_thresh_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$SE_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_SE_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_SE_thresh <- ggplot(DTBR, aes(x = DTBR_mean, y = SE_thresh))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  labs(x = '', y = 'SE Thresh')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_SE_thresh.png', plot = DTBR_SE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_SE_thresh_cor)

#  Storage thresh ----
DTBR_Storage_thresh_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$Storage_thresh, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_Storage_thresh_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_Storage_thresh <- ggplot(DTBR, aes(x = DTBR_mean, y = Storage_thresh))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_Storage_thresh.png', plot = DTBR_Storage_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_Storage_thresh_cor)

#  R Pvol ----
DTBR_R_Pvol_RC_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$R_Pvol_RC, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_R_Pvol_RC_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_R_Pvol_RC <- ggplot(DTBR, aes(x = DTBR_mean, y = R_Pvol_RC))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  labs(x = '', y = 'R Pvol RC')+
  theme_bw()+
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_R_Pvol_RC.png', plot = DTBR_R_Pvol_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
rm(DTBR_R_Pvol_RC_cor)

#  R Pint ----
DTBR_R_Pint_RC_cor <- cor.test(x =DTBR$DTBR_mean, y =DTBR$R_Pint_RC, method = 'spearman', exact = FALSE)
...
text_p <- grobTree(textGrob(paste0('p-value = ', round(DTBR_R_Pint_RC_cor[["p.value"]],3)), x = 0.60,  y = 0.2, hjust=0,
                            gp=gpar(col="black", fontsize=10)))
DTBR_R_Pint_RC <- ggplot(DTBR, aes(x = DTBR_mean, y = R_Pint_RC))+
  geom_point(color = '#DD8D29')+
  geom_smooth(method=lm, se=FALSE, fullrange=TRUE, color = '#DD8D29')+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_R_Pint_RC.png', plot = DTBR_R_Pint_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
DTBR_IE_grid <- plot_grid(DTBR_IE_effect, DTBR_mons_IE_effect,
                          ...
                          ncol = 2)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_IE_grid.png', plot = DTBR_IE_grid, width = 6, height = 7.5, units = c('in'), dpi = 300, bg = 'white')
...
DTBR_SE_grid <- plot_grid(DTBR_SE_effect, DTBR_mons_SE_effect,
                          ...
                          ncol = 2)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_DTBR_SE_grid.png', plot = DTBR_SE_grid, width = 6, height = 7.5, units = c('in'), dpi = 300, bg = 'white')
DTBR_SE_grid
...
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_IE_effect_mons.png', plot = perm_mons_IE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_mons_SE_effect <- ggplot(perm, aes(x = permeability, y = mons_SE_effect))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_SE_effect_mons.png', plot = perm_mons_SE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_mons_IE_thresh <- ggplot(perm, aes(x = permeability, y = mons_IE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_IE_thresh_mons.png', plot = perm_mons_IE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_mons_SE_thresh <- ggplot(perm, aes(x = permeability, y = mons_SE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_SE_thresh_mons.png', plot = perm_mons_SE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_mons_Storage_thresh <- ggplot(perm, aes(x = permeability, y = mons_Storage_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_Storage_thresh_mons.png', plot = perm_mons_Storage_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_mons_R_Pvol_RC <- ggplot(perm, aes(x = permeability, y = mons_R_Pvol_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_R_Pvol_RC_mons.png', plot = perm_mons_R_Pvol_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_mons_R_Pint_RC <- ggplot(perm, aes(x = permeability, y = mons_R_Pint_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_R_Pint_RC_mons.png', plot = perm_mons_R_Pint_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_IE_effect <- ggplot(perm, aes(x = permeability, y = IE_effect))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_IE_effect.png', plot = perm_IE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_SE_effect <- ggplot(perm, aes(x = permeability, y = SE_effect))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_SE_effect.png', plot = perm_SE_effect, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_IE_thresh <- ggplot(perm, aes(x = permeability, y = IE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_IE_thresh.png', plot = perm_IE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_SE_thresh <- ggplot(perm, aes(x = permeability, y = SE_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_SE_thresh.png', plot = perm_SE_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_Storage_thresh <- ggplot(perm, aes(x = permeability, y = Storage_thresh))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_Storage_thresh.png', plot = perm_Storage_thresh, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_R_Pvol_RC <- ggplot(perm, aes(x = permeability, y = R_Pvol_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_R_Pvol_RC.png', plot = perm_R_Pvol_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
perm_R_Pint_RC <- ggplot(perm, aes(x = permeability, y = R_Pint_RC))+
  ...
  annotation_custom(text_rho)+
  annotation_custom(text_p)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_R_Pint_RC.png', plot = perm_R_Pint_RC, width = 3.5, height = 3.5, units = c('in'), dpi = 300, bg = 'white')
...
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_IE_grid.png', plot = perm_IE_grid, width = 6, height = 7.5, units = c('in'), dpi = 300, bg = 'white')
perm_IE_grid
...
perm_SE_grid <- plot_grid(perm_SE_effect, perm_mons_SE_effect,
                        ...
                        ncol = 2)
ggsave('../Figures/Correlation Plots/Arizona/Arizona_Permeability_SE_grid.png', plot = perm_SE_grid, width = 6, height = 7.5, units = c('in'), dpi = 300, bg = 'white')
perm_SE_grid
